...
<nav class="navbar">
    ...
    <div class="main">
        ...
        ?>
                <div class="articleList"><h1><a href="detail.php?id=<?php echo $row['SubID']; ?> "><?php echo $row['Article_title']; ?></a></h1>
                <span>Published on: <?php echo $date; ?> At: <?php echo $time; ?> </span></div>
